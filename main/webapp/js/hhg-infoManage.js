    ...
    $(".p9").click();
	  $.ajax({
        ...
        success : function(data){
                    ...
                    var pageNumber=5;
                    // 计算页数
                    var page=Math.ceil(data.infoSystem.length/pageNumber);
                    //插入页数
                    ...
                    for(var i=0;i<pageNumber;i++){
                        ...
                        var str="<div class='infoMainMiniBlock'>"+
                                                            "<img src='"+data.infoSystem[i].pic+"' class='miniPic'>"+
                                                            "<div class='intro'>"+
                                                            "<div class='name'><img src='img/Arrow_04.gif'>"+data.infoSystem[i].title+"</div>"+
                                                            "<div class='message'>"+data.infoSystem[i].intro+"</div>"+
                                                            "</div>"+
                                                            "</div>";
                    ...
                    $(".pageNumMain").click(function(){
                        ...
                        for(var i=NumStart;i<Math.min(data.infoSystem.length,NumStart+pageNumber);i++){
                            var str="<div class='infoMainMiniBlock'>"+
                                                    "<img src='"+data.infoSystem[i].pic+"' class='miniPic'>"+
                                                    "<div class='intro'>"+
                                                    "<div class='name'><img src='img/Arrow_04.gif'>"+data.infoSystem[i].title+"</div>"+
                    ...
                    // 总记录数
                    $(".totalNumber").html(data.infoSystem.length);
                    // 总页数
